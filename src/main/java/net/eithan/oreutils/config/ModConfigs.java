...
public class ModConfigs {
    ...
    public static void addToBlockList(String blockedName) {
        BLOCK_LIST.add(blockedName);
    ...
    private static void createConfigs() {
        ...
        configs.addKeyValuePair(new Pair<>("auto_wb", true), "boolean to toggle the automatic wb feature");
    }
